...
import 'cart.dart'; // ajusta ruta si es necesario
import 'add_to_cart_sheet.dart'; // ajusta ruta si es necesario
...
class _OrderSummaryScreenState extends State<OrderSummaryScreen> {
  ...
  // Alto del carrusel de sugerencias (evita overflow con botón)
  static const double _kSugHeight = 240; // ← antes 210

  String _formatPrice(num n) => '\$${n.toStringAsFixed(2).replaceAll('.', ',')}';

  String get _itemId => (widget.addedDish['id'] ?? widget.addedDish['name']).toString();

  // Totales
  double get _productsTotal => (Cart.I.totalPrice).toDouble();
  ...
  Widget build(BuildContext context) {
    ...
    final price = (widget.addedDish['price'] as num?)?.toDouble() ?? 0.0;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // deja espacio real para la barra inferior
            ListView(
              padding: EdgeInsets.only(
                bottom: bottomBarHeight + bottomSafe + 24,
              ),
              children: [
                // Header
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          // Navegar al carrito completo si lo deseas
                        },
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        _dishImage(widget.addedDish['img']),
                        Padding(
                ...
                if (suggestions.isNotEmpty)
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (_, i) => _suggestionCard(suggestions[i], _kSugHeight),
                ...
                _summaryRow('Envío', _shipping == 0 ? '\$0' : _formatPrice(_shipping)),
                _summaryRow('Tarifa de servicio', _formatPrice(_serviceFee)),
              ],
            ),

            // Barra inferior: Subtotal + Ir a pagar (protegida por SafeArea)
            Positioned(
              left: 16,
              right: 16,
              bottom: 16,
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          elevation: 0,
                          minimumSize: const Size(0, 44), // altura mínima del botón
  ...
  // Imagen universal (assets o red) con placeholder/errores
  Widget _dishImage(dynamic src) {
    ...
    Widget fallback = Container(
      ...
      child: Column(
        ...
        children: const [
          Icon(Icons.image_not_supported_outlined, size: 36, color: Colors.black26),
          SizedBox(height: 6),
          Text('Imagen no disponible', style: TextStyle(color: Colors.black45, fontSize: 12)),
        ],
      ),
    );
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(text1, style: const TextStyle(color: Colors.black54, fontSize: 12)),
              Text(
                text2,
                style: TextStyle(
                  fontWeight: boldSecond ? FontWeight.w800 : FontWeight.w600,
                ),
              ),
            ],
          ),
      ...
      child: Material(
        ...
        child: Column(
          ...
          children: [
            ...
            // Botón (una sola línea con elipsis)
            Padding(
  ...
  // Mini-helper para thumbnails de sugerencias (assets/red)
  Widget _thumbImage(dynamic src) {
